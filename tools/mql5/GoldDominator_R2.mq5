//+------------------------------------------------------------------+
//|                                          GoldDominator_R2.mq5  |
//|   Gold Dominator R2 - a safer XAUUSD grid/recovery EA.           |
//|                                                                  |
...
//+------------------------------------------------------------------+
#property copyright "Gold Dominator R2 - Execution Desk"
...
input long            InpMagic       = 16082020;    // Magic (unique per variant so they don't clash)
input string          InpComment     = "GoldDominatorR2"; // order comment
