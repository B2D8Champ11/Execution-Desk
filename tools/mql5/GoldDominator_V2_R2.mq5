//+------------------------------------------------------------------+
//|                                             GoldDominator_V2_R2.mq5  |
//|   Gold Dominator V2 - safer XAUUSD scalp/grid EA (session-tuned). |
//|                                                                  |
...
//+------------------------------------------------------------------+
#property copyright "Gold Dominator V2 R2 - Execution Desk"
...
input string          InpComment     = "GoldDominatorV2R2"; // order comment
