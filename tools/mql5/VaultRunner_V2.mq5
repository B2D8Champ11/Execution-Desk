...
//+------------------------------------------------------------------+
#property copyright "Vault Runner V2 - Execution Desk"
...
input long            InpMagic       = 16082031;    // Magic (unique per variant so they don't clash)
input string          InpComment     = "VaultRunnerV2"; // order comment
